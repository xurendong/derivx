...
function CalcGreeks(module, calc_greek, s, h, k, x, v, r, q, t, p, is_call, is_kop_delay, barrier_type, calc_price, runs_step, year_days, run_from, run_days) {
    let inputs = {'calc_greek':calc_greek, 's':s, 'h':h, 'k':k, 'x':x, 'v':v, 'r':r, 'q':q, 't':t, 'p':p, 'is_call':is_call, 'is_kop_delay':is_kop_delay, 'barrier_type':barrier_type, 
