...
function Gap_CalcPrice(module, s, k_1, k_2, r, q, v, t, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_gap_calc_price, 0, JSON.stringify(inputs)))
...
function Gap_CalcPayoff(module, s, k_1, k_2, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_gap_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function CashOrNothing_CalcPrice(module, s, k, r, q, v, t, cash, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_cash_or_nothing_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function CashOrNothing_CalcPayoff(module, s, k, cash, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_cash_or_nothing_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function AssetOrNothing_CalcPrice(module, s, k, r, q, v, t, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_asset_or_nothing_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function AssetOrNothing_CalcPayoff(module, s, k, is_call) {
    ...
    let result = JSON.parse(module.DirectCall(func_asset_or_nothing_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function SuperShare_CalcPrice(module, s, k_l, k_h, r, q, v, t) {
    ...
    let result = JSON.parse(module.DirectCall(func_super_share_calc_price, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
...
function SuperShare_CalcPayoff(module, s, k_l, k_h) {
    ...
    let result = JSON.parse(module.DirectCall(func_super_share_calc_payoff, 0, JSON.stringify(inputs)))
    if(result['return_code'] !== 0) {
        console.log(result['return_code'], result['return_info'])
    }
    return result['result_data']
