...
let payoff_basic         = 0x0001 // 资金流-票息等基础
let payoff_margin_pro    = 0x0002 // 资金流-保证金收益
let payoff_option_fee    = 0x0004 // 资金流-期权费收入
let payoff_prefix_rebate = 0x0008 // 资金流-前端返息类
let payoff_suffix_rebate = 0x0010 // 资金流-后端返息类
...
class Config {
    constructor() {
        ...
        this.strike_ratio = 0.0 // 行权界限，非百分比
        ...
        this.uexuko_coupon = 0.0 // 对于无敲出无行权的情况，客户只要求得到固定收益
        this.uexuko_coupon_ann = false // false 为绝对收益率，true 为年化收益率
        this.uexuko_coupon_use = false // 是否支付 uexuko 收益，false 为红利票息等同敲出票息，true 为单独指定红利票息
...
async function Test_DerivX_Autocall_Fixed_Coupon_Notes() {
    ...
    config.strike_ratio = 0.8 // 行权界限，非百分比
    ...
    tasker_test.plugin_id = 'derivx_autocall_fixed_coupon_notes'
...
Test_DerivX_Autocall_Fixed_Coupon_Notes()
