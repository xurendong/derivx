...
func_make_data_gbb = 2
func_make_data_cir = 3
func_make_data_jdp = 4
func_make_data_hest = 5
func_make_data_sabr = 6
func_make_data_user = 7

# GBM：几何布朗运动 (指数布朗运动) Geometric Brownian Motion
# GBB：几何布朗桥模型 (指数布朗桥模型) Geometric Brownian Bridge Model
