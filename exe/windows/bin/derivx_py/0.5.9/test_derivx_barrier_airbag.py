...
class Config(object):
    def __init__(self):
        ...
        self.s = 0.0 # 初始价格
        self.k_earn_cap = 0.0 # 行权价，未敲入，收益封顶，大数则无封顶
        self.k_earn_get = 0.0 # 行权价，未敲入，获得收益
        self.k_loss_cap = 0.0 # 行权价，有敲入，收益封顶，大数则无封顶
        self.k_loss_get = 0.0 # 行权价，有敲入，产生损失
        self.k_loss_flo = 0.0 # 行权价，有敲入，损失保底，为零则无保底，也即不追保比率
        ...
        self.option_fee = 0.0 # 期权费费率，年化，CalcPrice 时此入参不参与计算
