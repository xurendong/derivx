...
def CalcGreeks_Spread_Bull_Call(vanilla, model, greek, s, k_l_c_l, k_h_c_s, r, q, sigma, t, is_long):
    result = 0.0
    if model == "bs":
        if greek == "d":
            delta_low_call_long = vanilla.CalcGreeks(model, greek, s, k_l_c_l, r, q, sigma, t, True, True)
            delta_high_call_short = vanilla.CalcGreeks(model, greek, s, k_h_c_s, r, q, sigma, t, False, True)
            result = delta_low_call_long + delta_high_call_short
        elif greek == "g":
            gamma_low_call_long = vanilla.CalcGreeks(model, greek, s, k_l_c_l, r, q, sigma, t, True)
            gamma_high_call_short = vanilla.CalcGreeks(model, greek, s, k_h_c_s, r, q, sigma, t, False)
            result = gamma_low_call_long + gamma_high_call_short
        elif greek == "v":
            vega_low_call_long = vanilla.CalcGreeks(model, greek, s, k_l_c_l, r, q, sigma, t, True)
            vega_high_call_short = vanilla.CalcGreeks(model, greek, s, k_h_c_s, r, q, sigma, t, False)
            result = vega_low_call_long + vega_high_call_short
        elif greek == "t":
            theta_low_call_long = vanilla.CalcGreeks(model, greek, s, k_l_c_l, r, q, sigma, t, True, True)
            theta_high_call_short = vanilla.CalcGreeks(model, greek, s, k_h_c_s, r, q, sigma, t, False, True)
            result = theta_low_call_long + theta_high_call_short
        elif greek == "r":
            rho_low_call_long = vanilla.CalcGreeks(model, greek, s, k_l_c_l, r, q, sigma, t, True, True, False, False)
            rho_high_call_short = vanilla.CalcGreeks(model, greek, s, k_h_c_s, r, q, sigma, t, False, True, False, False)
...
def CalcGreeksSurface_Spread_Bull_Call(vanilla, model, greek, array_s, k_l_c_l, k_h_c_s, r, q, sigma, array_t, is_long):
...
def Test_Vanilla_European():
    ...
    array_s = np.arange(5.0, 105.0, 5.0)
    array_t = np.arange(0.004, 1.004, 1.0 / 250)
    model, s, k_l, k_m, k_h, r, q, sigma, t, is_long = "bs", 50.0, 40.0, 50.0, 60.0, 0.05, 0.0, 0.2, 0.5, True
    ...
    #print(CalcGreeks_Spread_Bull_Call(vanilla, model, "d", s, k_l, k_h, r, q, sigma, t, is_long))
    #print(CalcGreeks_Spread_Bull_Call(vanilla, model, "g", s, k_l, k_h, r, q, sigma, t, is_long))
    #print(CalcGreeks_Spread_Bull_Call(vanilla, model, "v", s, k_l, k_h, r, q, sigma, t, is_long))
    #print(CalcGreeks_Spread_Bull_Call(vanilla, model, "t", s, k_l, k_h, r, q, sigma, t, is_long))
    #print(CalcGreeks_Spread_Bull_Call(vanilla, model, "r", s, k_l, k_h, r, q, sigma, t, is_long))
    #surface = CalcGreeksSurface_Spread_Bull_Call(vanilla, model, "d", array_s, k_l, k_h, r, q, sigma, array_t, is_long)
    #surface = CalcGreeksSurface_Spread_Bull_Call(vanilla, model, "g", array_s, k_l, k_h, r, q, sigma, array_t, is_long)
    #surface = CalcGreeksSurface_Spread_Bull_Call(vanilla, model, "v", array_s, k_l, k_h, r, q, sigma, array_t, is_long)
    #surface = CalcGreeksSurface_Spread_Bull_Call(vanilla, model, "t", array_s, k_l, k_h, r, q, sigma, array_t, is_long)
    surface = CalcGreeksSurface_Spread_Bull_Call(vanilla, model, "r", array_s, k_l, k_h, r, q, sigma, array_t, is_long)
    FigureResult(array_s, array_t, surface)
